...
const HeaderNavIcons = () => {
  ...
  return (
    <nav className="hidden sm:flex items-center py-1">
      <div
        className="w-full h-full py-5 px-8 rounded-lg cursor-pointer hover:bg-whiteNav dark:hover:bg-hoverDarkColor"
      ...
      <div className="w-full h-full py-5 px-8 rounded-lg cursor-pointer hover:bg-whiteNav dark:hover:bg-hoverDarkColor">
        <svg
          aria-label="만들기"
          role="img"
          viewBox="0 0 26 26"
